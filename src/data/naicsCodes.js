// Full U.S. NAICS 2022 6-digit code list (code + industry title), sourced
// from the harmonized North American NAICS concordance, filtered down to
// codes valid in the US classification (dropped Canada-only/Mexico-only
// subdivisions). Used by WARDOG's NAICS search so users aren't limited to
// a small hardcoded shortlist.
export const NAICS_CODES = [
  ...
  { code: '211111', title: 'Crude Petroleum and Natural Gas Extraction' },
  { code: '211112', title: 'Natural Gas Liquid Extraction' },
  { code: '212111', title: 'Bituminous Coal and Lignite Surface Mining' },
  { code: '212112', title: 'Bituminous Coal Underground Mining' },
  { code: '212113', title: 'Anthracite Mining' },
  { code: '212210', title: 'Iron Ore Mining' },
  { code: '212221', title: 'Gold Ore Mining' },
  { code: '212222', title: 'Silver Ore Mining' },
  { code: '212231', title: 'Lead Ore and Zinc Ore Mining' },
  { code: '212234', title: 'Copper Ore and Nickel Ore Mining' },
  { code: '212291', title: 'Uranium-Radium-Vanadium Ore Mining' },
  { code: '212299', title: 'All Other Metal Ore Mining' },
  ...
  { code: '212324', title: 'Kaolin and Ball Clay Mining' },
  { code: '212325', title: 'Clay and Ceramic and Refractory Minerals Mining' },
  { code: '212391', title: 'Potash, Soda, and Borate Mineral Mining' },
  { code: '212392', title: 'Phosphate Rock Mining' },
  { code: '212393', title: 'Other Chemical and Fertilizer Mineral Mining' },
  { code: '212399', title: 'All Other Nonmetallic Mineral Mining' },
  ...
  { code: '311221', title: 'Wet Corn Milling' },
  ...
  { code: '315110', title: 'Hosiery and Sock Mills' },
  { code: '315190', title: 'Other Apparel Knitting Mills' },
  { code: '315210', title: 'Cut and Sew Apparel Contractors' },
  { code: '315220', title: 'Men’s and Boys’ Cut and Sew Apparel Manufacturing' },
  { code: '315240', title: 'Women’s, Girls’, and Infants’ Cut and Sew Apparel Manufacturing' },
  { code: '315280', title: 'Other Cut and Sew Apparel Manufacturing' },
  ...
  { code: '316992', title: 'Women\'s Handbag and Purse Manufacturing' },
  { code: '316998', title: 'All Other Leather Good and Allied Product Manufacturing' },
  ...
  { code: '321213', title: 'Engineered Wood Member (except Truss) Manufacturing' },
  { code: '321214', title: 'Truss Manufacturing' },
  ...
  { code: '322121', title: 'Paper (except Newsprint) Mills' },
  { code: '322122', title: 'Newsprint Mills' },
  ...
  { code: '325992', title: 'Photographic Film, Paper, Plate, and Chemical Manufacturing' },
  ...
  { code: '333244', title: 'Printing Machinery and Equipment Manufacturing' },
  { code: '333249', title: 'Other Industrial Machinery Manufacturing' },
  { code: '333314', title: 'Optical Instrument and Lens Manufacturing' },
  { code: '333316', title: 'Photographic and Photocopying Equipment Manufacturing' },
  { code: '333318', title: 'Other Commercial and Service Industry Machinery Manufacturing' },
  ...
  { code: '333911', title: 'Pump and Pumping Equipment Manufacturing' },
  { code: '333912', title: 'Air and Gas Compressor Manufacturing' },
  { code: '333913', title: 'Measuring and Dispensing Pump Manufacturing' },
  ...
  { code: '333997', title: 'Scale and Balance Manufacturing' },
  { code: '333999', title: 'All Other Miscellaneous General Purpose Machinery Manufacturing' },
  ...
  { code: '334613', title: 'Blank Magnetic and Optical Recording Media Manufacturing' },
  ...
  { code: '335221', title: 'Household Cooking Appliance Manufacturing' },
  { code: '335222', title: 'Household Refrigerator and Home Freezer Manufacturing' },
  { code: '335224', title: 'Household Laundry Equipment Manufacturing' },
  { code: '335228', title: 'Other Major Household Appliance Manufacturing' },
  ...
  { code: '335911', title: 'Storage Battery Manufacturing' },
  { code: '335912', title: 'Primary Battery Manufacturing' },
  ...
  { code: '336112', title: 'Light Truck and Utility Vehicle Manufacturing' },
  ...
  { code: '337124', title: 'Metal Household Furniture Manufacturing' },
  { code: '337125', title: 'Household Furniture (except Wood and Metal) Manufacturing' },
  ...
  { code: '424320', title: 'Men\'s and Boys\' Clothing and Furnishings Merchant Wholesalers' },
  { code: '424330', title: 'Women\'s, Children\'s, and Infants\' Clothing and Accessories Merchant Wholesalers' },
  ...
  { code: '424940', title: 'Tobacco and Tobacco Product Merchant Wholesalers' },
  ...
  { code: '425110', title: 'Business to Business Electronic Markets' },
  ...
  { code: '441228', title: 'Motorcycle, ATV, and All Other Motor Vehicle Dealers' },
  { code: '441310', title: 'Automotive Parts and Accessories Stores' },
  { code: '441320', title: 'Tire Dealers' },
  { code: '442110', title: 'Furniture Stores' },
  { code: '442210', title: 'Floor Covering Stores' },
  { code: '442291', title: 'Window Treatment Stores' },
  { code: '442299', title: 'All Other Home Furnishings Stores' },
  { code: '443141', title: 'Household Appliance Stores' },
  { code: '443142', title: 'Electronics Stores' },
  { code: '444110', title: 'Home Centers' },
  { code: '444120', title: 'Paint and Wallpaper Stores' },
  { code: '444130', title: 'Hardware Stores' },
  { code: '444190', title: 'Other Building Material Dealers' },
  { code: '444210', title: 'Outdoor Power Equipment Stores' },
  { code: '444220', title: 'Nursery, Garden Center, and Farm Supply Stores' },
  { code: '445110', title: 'Supermarkets and Other Grocery (except Convenience) Stores' },
  { code: '445120', title: 'Convenience Stores' },
  { code: '445210', title: 'Meat Markets' },
  { code: '445220', title: 'Fish and Seafood Markets' },
  { code: '445230', title: 'Fruit and Vegetable Markets' },
  { code: '445291', title: 'Baked Goods Stores' },
  { code: '445292', title: 'Confectionery and Nut Stores' },
  { code: '445299', title: 'All Other Specialty Food Stores' },
  { code: '445310', title: 'Beer, Wine, and Liquor Stores' },
  { code: '446110', title: 'Pharmacies and Drug Stores' },
  { code: '446120', title: 'Cosmetics, Beauty Supplies, and Perfume Stores' },
  { code: '446130', title: 'Optical Goods Stores' },
  { code: '446191', title: 'Food (Health) Supplement Stores' },
  { code: '446199', title: 'All Other Health and Personal Care Stores' },
  { code: '447110', title: 'Gasoline Stations with Convenience Stores' },
  { code: '447190', title: 'Other Gasoline Stations' },
  { code: '448110', title: 'Men\'s Clothing Stores' },
  { code: '448120', title: 'Women\'s Clothing Stores' },
  { code: '448130', title: 'Children\'s and Infants\' Clothing Stores' },
  { code: '448140', title: 'Family Clothing Stores' },
  { code: '448150', title: 'Clothing Accessories Stores' },
  { code: '448190', title: 'Other Clothing Stores' },
  { code: '448210', title: 'Shoe Stores' },
  { code: '448310', title: 'Jewelry Stores' },
  { code: '448320', title: 'Luggage and Leather Goods Stores' },
  { code: '451110', title: 'Sporting Goods Stores' },
  { code: '451120', title: 'Hobby, Toy, and Game Stores' },
  { code: '451130', title: 'Sewing, Needlework, and Piece Goods Stores' },
  { code: '451140', title: 'Musical Instrument and Supplies Stores' },
  { code: '451211', title: 'Book Stores' },
  { code: '451212', title: 'News Dealers and Newsstands' },
  { code: '452111', title: 'Department Stores (except Discount Department Stores)' },
  { code: '452112', title: 'Discount Department Stores' },
  { code: '452910', title: 'Warehouse Clubs and Supercenters' },
  { code: '452990', title: 'All Other General Merchandise Stores' },
  { code: '453110', title: 'Florists' },
  { code: '453210', title: 'Office Supplies and Stationery Stores' },
  { code: '453220', title: 'Gift, Novelty, and Souvenir Stores' },
  { code: '453310', title: 'Used Merchandise Stores' },
  { code: '453910', title: 'Pet and Pet Supplies Stores' },
  { code: '453920', title: 'Art Dealers' },
  { code: '453930', title: 'Manufactured (Mobile) Home Dealers' },
  { code: '453991', title: 'Tobacco Stores' },
  { code: '453998', title: 'All Other Miscellaneous Store Retailers (except Tobacco Stores)' },
  { code: '454111', title: 'Electronic Shopping' },
  { code: '454112', title: 'Electronic Auctions' },
  { code: '454113', title: 'Mail-Order Houses' },
  { code: '454210', title: 'Vending Machine Operators' },
  { code: '454310', title: 'Fuel Dealers' },
  { code: '454390', title: 'Other Direct Selling Establishments' },
  ...
  { code: '512210', title: 'Record Production' },
  { code: '512220', title: 'Integrated Record Production/Distribution' },
  ...
  { code: '517110', title: 'Wired Telecommunications Carriers' },
  { code: '517210', title: 'Wireless Telecommunications Carriers (except Satellite)' },
  { code: '517410', title: 'Satellite Telecommunications' },
  { code: '517911', title: 'Telecommunications Resellers' },
  { code: '517919', title: 'All Other Telecommunications' },
  { code: '518210', title: 'Data Processing, Hosting, and Related Services' },
  { code: '519110', title: 'News Syndicates' },
  { code: '519120', title: 'Libraries and Archives' },
  ...
  { code: '522120', title: 'Savings Institutions' },
  { code: '522130', title: 'Credit Unions' },
  { code: '522190', title: 'Other Depository Credit Intermediation' },
  ...
  { code: '522293', title: 'International Trade Financing' },
  { code: '522294', title: 'Secondary Market Financing' },
  { code: '522298', title: 'All Other Nondepository Credit Intermediation' },
  ...
  { code: '523140', title: 'Commodity Contracts Brokerage' },
  ...
  { code: '532220', title: 'Formal Wear and Costume Rental' },
  { code: '532230', title: 'Video Tape and Disc Rental' },
  { code: '532291', title: 'Home Health Equipment Rental' },
  { code: '532292', title: 'Recreational Goods Rental' },
  { code: '532299', title: 'All Other Consumer Goods Rental' },
  ...
  { code: '541712', title: 'Research and Development in the Physical, Engineering, and Life Sciences (except Biotechnology)' },
  ...
  { code: '721310', title: 'Rooming and Boarding Houses' },
  ...
  { code: '811118', title: 'Other Automotive Mechanical and Electrical Repair and Maintenance' },
